...
class BidQuery final :
 ...
 public:
  ...
  ~BidQuery() override;
  explicit constexpr BidQuery(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class BidReply final :
 ...
 public:
  ...
  ~BidReply() override;
  explicit constexpr BidReply(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
