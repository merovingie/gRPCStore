...
std::unique_ptr< Vendor::Stub> Vendor::NewStub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options) {
  (void)options;
  std::unique_ptr< Vendor::Stub> stub(new Vendor::Stub(channel, options));
  return stub;
}

Vendor::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  : channel_(channel), rpcmethod_getProductBid_(Vendor_method_names[0], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
void Vendor::Stub::async::getProductBid(::grpc::ClientContext* context, const ::vendor::BidQuery* request, ::vendor::BidReply* response, std::function<void(::grpc::Status)> f) {
...
void Vendor::Stub::async::getProductBid(::grpc::ClientContext* context, const ::vendor::BidQuery* request, ::vendor::BidReply* response, ::grpc::ClientUnaryReactor* reactor) {
